    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('floor', models.IntegerField(max_length=1, verbose_name='楼层')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('speed', models.CharField(blank=True, max_length=64, null=True, verbose_name='速度')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=128, verbose_name='网卡名字')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('server', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='disk_list', to='repository.server', verbose_name='服务器')),
            ],
            options={
